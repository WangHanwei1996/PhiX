...
- Release notes live in `changelog/v<X.Y.Z>/RELEASE.md` and are written in **Chinese**; each feature bump adds a new version directory (mirror this when adding features). The codebase is currently at v2.39.0.
